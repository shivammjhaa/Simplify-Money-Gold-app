...
const EnhancedDetailsScreen: React.FC<Props> = ({ route, navigation }) => {
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text style={styles.currentPrice}>{formatPrice(weeklyData.current.price_per_gram_inr)}</Text>
...
export default EnhancedDetailsScreen;